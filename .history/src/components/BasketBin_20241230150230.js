...
const BasketBin = () => {
    return (
        <div className={styles.projectInfo}>
            ...
            <p>You can find the source code for this project on github at: <a href="https://github.com/DerrickHa/ht6" target="_blank" rel="noopener noreferrer">GitHub repository</a>.</p>
