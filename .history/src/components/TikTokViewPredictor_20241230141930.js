...
const TikTokViewPredictor = () => {
    return (
        <div className={styles.projectInfo}>
            ...
            <p>You can find the source code for this project on my <a href="https://github.com/your-username/basketbin" target="_blank" rel="noopener noreferrer">GitHub repository</a>.</p>

            <h3>Project Images</h3>
            <div className={styles.imageContainer}>
                <img src="/images/TikTokViewPredictor-1.jpg" alt="BasketBin smart bin" className={styles.projectImage} />
                <img src="/images/TikTokViewPredictor-2.jpg" alt="BasketBin mobile app" className={styles.projectImage} />
            </div>
        </div>
    );
}
